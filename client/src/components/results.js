...
export default function Results() {
 ...
 useEffect(() => {
   ...
   async function getRecords() {
     const response = await fetch(`http://ec2-44-202-229-106.compute-1.amazonaws.com:5000/query/?&query=${uriParams.get("query")}&languages=${uriParams.get("languages")}&onlyCode=${uriParams.get("onlyCode")}`);
 ...
 async function deleteRecord(id) {
   await fetch(`http://ec2-44-202-229-106.compute-1.amazonaws.com:5000/${id}`, {
     method: "DELETE"
   });
