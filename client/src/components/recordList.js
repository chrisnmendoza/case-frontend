...
export default function RecordList() {
 ...
 useEffect(() => {
   async function getRecords() {
     const response = await fetch(`http://http://ec2-54-234-142-176.compute-1.amazonaws.com/:54321/record/`);
 ...
 async function deleteRecord(id) {
   await fetch(`http://http://ec2-54-234-142-176.compute-1.amazonaws.com/:54321/${id}`, {
     method: "DELETE"
   });
